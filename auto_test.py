...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str,
                        default="/data2/hsl/T60_train_test/save_model/0628_2k_attFPN_old_hybl_zgc_yqh_zgcfx_echo_NONoise/",
                        help= '保存的模型路径')
    parser.add_argument('--test_epochs', type=list, default=[7,15,25],help='要测试的epoch，列表')  # 记得改epoch数
    parser.add_argument('--test_freq', type=int, default=2000,choices=[500,1000,2000,4000])
    ...
    parser.add_argument('--outputresult_dir_head', type=str,default="/data2/hsl/T60_train_test/test_result/",help='输出测试结果的路径')
    ...
    for test_epoch in args.test_epochs:
        ...
        for i in range(len(val_dict_root_list)):
            ...
            val_transformed_dataset = Dataset_dict(root_dir=val_dict_root, transform=data_transform,
                                                   ...
                                                   random_choose_slice=False, train=False, choose_data=choose_data,
                                                   choose_key='_20dB')
