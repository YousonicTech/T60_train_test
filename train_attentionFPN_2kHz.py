...
import os
import glob
from new_data_load_original_random import Dataset_dict, collate_fn
...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/data2/hsl/T60_train_test/save_model/0628_2k_attFPN_old_hybl_zgc_yqh_zgcfx_NONoise_3040_1_2_random/')  # 需要改一下倍频程
    parser.add_argument('--model_path', type=str, default="/data2/hsl/T60_train_test/save_model/0628_2k_attFPN_old_hybl_zgc_yqh_zgcfx_NONoise_3040_1_2_random")
    parser.add_argument('--load_pretrain', type=bool, default=False)
    # 125Hz:(0, 7); 250Hz:(1, 10); 500Hz:(2, 13); 1kHz:(3, 16); 2kHz:(4, 19)
    parser.add_argument('--which_freq', type=int, default=4)  # 换倍频程
    parser.add_argument('--freq_loc', type=int, default=19)  # t60选择倍频程,500hz对应13
...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        ...
        #train_dict_root = "/data3/hsl/PT/No_Noise/Old_pt/"
        train_dict_root = "/data3/hsl/PT/No_Noise/2K/"
        # train_dict_root = "/data2/hsl/0412_pt_old_data_with_clean/"
        ...
        val_dict_root = "/data3/hsl/TEST_PT/LiveRecord_QTQW/"
        batch_size = 50
        val_batch_size = 5
        failed_file = "/data3/hsl/TEST_PT/LiveRecord_QTQW/val_hybl_LiveRecord_QTQW/six-eight/six-eight-ch2-0_35.pt"
    ...
    train_transformed_dataset = Dataset_dict(root_dir=train_dict_root, root_dir1=train_dict_root1,
                                             root_dir2=train_dict_root2, root_dir3=train_dict_root3,
                                             root_dir4=train_dict_root4, transform=data_transform,
    ...
    val_transformed_dataset = Dataset_dict(root_dir=val_dict_root, transform=data_transform, start_freq=args.start_freq,
                                           ...
                                           random_choose_slice=False,train=False)
