...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='save_model/0914_2000Hz_FPN_lre5_alpha1_beta05') # 需要改一下倍频程
    ...
    parser.add_argument('--freq_loc', type=int, default=13)   # 换倍频程
...
def train_net(start_epoch, n_epochs, train_loader, val_loader, batch_size, args):
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        print('in case no t60, the chosen last t60 are:', gt_t60_reshape.T)
