...
import os
import glob
from train_dataloader import Dataset_dict, collate_fn
from test_dataloader import Dataset_dict as test_Dataset_dict
from test_dataloader import collate_fn as test_collate_fn
...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/data1/zdm/code/WithEnhancement/NoNoiseAndOne3040Model/')  # 需要改一下倍频程
    parser.add_argument('--clean_dir',type=str, default='/data1/zdm/CleanSpeech/speech_pt/CatChinese/')
...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        train_dict_root = "/data/pyq/pyq_train/"
        train_dict_root1 = None
        val_dict_root = "/data/pyq/pyq_test/"
        batch_size = 36
        val_batch_size = 1
        failed_file = "/data/pyq/pyq_train/0403/arthur-sykes-rymer-auditorium-university-york/arthur-sykes-rymer-auditorium-university-york_s1r2_0_1_3_arthur-sykes-rymer-auditorium-university-york_上海话女声_1_TIMIT_a012_140_150_0dB-0.pt"
    else:

        train_dict_root = "/data1/zdm/T60_500Hz_Data_pt/train_one3040NoNoise/"  # "/data/pyq/T60_500Hz_pt_with_clean/"
        clean_dir = args.clean_dir
        train_dict_root1 =None   # 新数据地址
        # clean_dict_root = "/data2/pyq/clean_chinese_pt/"

        # train_dict_root = "/mnt/sda/xbj/0815_GEN_DATASET/train"
        val_dict_root = "/data1/zdm/T60_500Hz_Data_pt/val/LiveRecord"
        batch_size = 6
        val_batch_size = 6
        failed_file = "/data1/zdm/T60_500Hz_Data_pt/val/NoNoise/hybl_chinese/eight-four/eight-four_eight-four-ch4_上海话女声-1_N_NdB-0.pt" 
    ...
    train_transformed_dataset = Dataset_dict(root_dir=train_dict_root,
                                                clean_dir=clean_dir,
                                                transform=data_transform,
                                                start_freq=args.start_freq,
                                                end_freq=args.end_freq,
                                                which_freq=args.which_freq,
    ...
    val_transformed_dataset = test_Dataset_dict(root_dir=val_dict_root,
                                            # clean_dir=clean_dir,
                                            transform=data_transform,
                                            start_freq=args.start_freq, 
                                            end_freq=args.end_freq,
