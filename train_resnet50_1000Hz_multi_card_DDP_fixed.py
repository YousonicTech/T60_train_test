...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='save_model/0412_autoLoss/')  # 需要改一下倍频程
    ...
    parser.add_argument('--freq_loc', type=int, default=13)  # t60选择倍频程,500hz对应13,1k对应16，2k对应19
...
def preprocess_img(image):
    ...
    for i in range(image.shape[0]):
        ...
        temp_img = torch.Tensor(cv2.resize(temp_img.squeeze().numpy(), (224, 224)))  # [224,224]
...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        ...
        train_dict_root = "/data/pyq/yousonic/T60_500Hz_pt_with_clean/"#"/data/pyq/yousonic/pt_val_data/"#"/data/xbj/0902_1000hz_with_clean/train"
        train_dict_root1 = None#"/data/hsl/0324_pt_with_clean"  # 新数据地址

        # train_dict_root = "/mnt/sda/xbj/0815_GEN_DATASET/train"
        val_dict_root = "/data/pyq/yousonic/pt_val_data/"#"/data/xbj/0902_1000hz_with_clean/val"
        batch_size = 30
        val_batch_size = 6
        failed_file = "/data/xbj/0902_1000hz_with_clean/train/york-guildhall-council-chamber/york-guildhall-council-chamber_councilchamber_s3_r1_ir_1_96000_4_york-guildhall-council-chamber_粤语女声_6_TIMIT_b099_230_240_20dB-0.pt"        # failed_file = "/data/xbj/0913_2000hz_with_clean_forFPN/train/Venues/Venues_MillsGreekTheater_left_Venues_东北话男声_1_TIMIT_a019_40_50_20dB-0.pt"
