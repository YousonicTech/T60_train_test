...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='save_model/0330_autoLoss/')  # 需要改一下倍频程
    parser.add_argument('--model_path', type=str, default='save_model/')
    parser.add_argument('--load_pretrain', type=bool, default=False)
    # 125Hz:(0, 7); 250Hz:(1, 10); 500Hz:(2, 13); 1kHz:(3, 16); 2kHz:(4, 19)
    parser.add_argument('--which_freq', type=int, default=3)  # 换倍频程
    parser.add_argument('--freq_loc', type=int, default=16)  # t60选择倍频程,500hz对应13,1k对应16，2k对应19
...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        ...
        train_dict_root = "/data/xbj/0902_1000hz_with_clean/train"
        train_dict_root1 = "/data/hsl/0324_pt_with_clean"  # 新数据地址
